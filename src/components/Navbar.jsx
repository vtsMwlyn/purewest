...
export default function Navbar() {
	return (
		<>
			<nav className="w-full bg-black text-white flex justify-center">
				<div className="w-11/12 xl:w-5/6 grid grid-cols-8">
					...
					<Link to="/about" className="w-full h-full hover:bg-yellow-400 uppercase flex justify-center items-center transition">About</Link>
