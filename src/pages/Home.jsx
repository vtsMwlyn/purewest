      ...
      {menuOpen && (
        ...
        >
          ...
          <button
            ...
            className="text-[0.5rem] tracking-[3px] uppercase px-6 py-3 font-bold w-fit"
...
/* ─── Products ─────────────────────────────────────────────── */
function Products({ onOpenPanel }) {
  const tiles = [
    { id: "jarrah",  ta: "TA 35+", name: "Jarrah Honey", sub: "Active Honey · South-West WA",       img: "/images/tile-img-jarrah.jpg" },
    { id: "marri35", ta: "TA 35+", name: "Marri Honey",  sub: "Active Honey · South-West WA",       img: "/images/tile-img-marri35.jpg" },
    { id: "marri15", ta: "TA 15+", name: "Marri Honey",  sub: "Active Honey · Everyday Wellness",   img: "/images/tile-img-marri15.jpg" },
  ];
...
export default function Home() {
  ...
  return (
    <div style={{ background: C.dark, color: C.text, fontFamily: "'Libre Baskerville', serif" }}>
      <Nav onShopNow={scrollToProducts} />
      <Hero onShopNow={scrollToProducts} />
      <About />
      <Why />
      <RangePhoto />
      <Quote />
      <Products onOpenPanel={openPanel} />
      <Testimonials />
      <Shipping />
      <Footer />

      {panelId && <ProductPanel productId={panelId} onClose={closePanel} />}
    </div>
  );
}
